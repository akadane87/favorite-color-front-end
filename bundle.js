...
/***/ function(module, exports, __webpack_require__) {
	...
	var cEvents = __webpack_require__(9);
...
/***/ function(module, exports) {
	...
	var config = {
	  host: "https://salty-brook-88442.herokuapp.com"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var c_api = __webpack_require__(10);
	var c_ui = __webpack_require__(11);

	var onPostColor = function onPostColor(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  c_api.postColor(data).then(c_ui.postColorSuccess).catch(c_ui.failure);
	};

	var onGetAllColors = function onGetAllColors(event) {
	  event.preventDefault();
	  c_api.getAllColors().then(c_ui.getAllColorsSuccess).catch(c_ui.failure);
	};

	var onDeleteColor = function onDeleteColor(e) {
	  e.preventDefault();
	  var colorId = $(this).attr('data-id');
	  c_api.deleteColor(colorId).then(function () {
	    c_ui.deleteColorSuccess(colorId);
	  }).catch(c_ui.failure);
	};

	var onUpdateColor = function onUpdateColor(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	  var colorId = $(this).attr('data-id');
	  c_api.updateColor(colorId, data).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var postColor = function postColor(data) {
	  return $.ajax({
	...
	var getAllColors = function getAllColors(data) {
	  return $.ajax({
	    url: config.host + '/colors',
	    method: 'GET',
	    data: data,
	...
	var deleteColor = function deleteColor(id) {
	  return $.ajax({
	...
	var updateColor = function updateColor(id, data) {
	  return $.ajax({
	    url: config.host + '/colors/' + id,
	    method: 'PATCH',
	    data: data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var listColorTemplates = __webpack_require__(12);

	var success = function success(data) {};

	var postColorSuccess = function postColorSuccess(data) {};

	var getAllColorsSuccess = function getAllColorsSuccess(data) {
	  $('.color_list').show();
	  $('.color_list').html(listColorTemplates(data));
	};

	var deleteColorSuccess = function deleteColorSuccess(id) {
	  var deletedColor = $('#color-' + id);
	  deletedColor.remove();
	};

	var updateColorSuccess = function updateColorSuccess(id, data) {
	...
	module.exports = {
	  postColorSuccess: postColorSuccess,
	  deleteColorSuccess: deleteColorSuccess,
	  getAllColorsSuccess: getAllColorsSuccess,
	  updateColorSuccess: updateColorSuccess,
	  success: success,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},depth0,{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "<div id='color-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "' class=\"color_list_box\">\n  <p>"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " - <span data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\"> "
	    + alias4(((helper = (helper = helpers.favorite || (depth0 != null ? depth0.favorite : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"favorite","hash":{},"data":data}) : helper)))
	    + "</span></p>\n  <button data-id='"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "' class=\"delete_color\" formtarget=\"\"name=\"subject\" type=\"submit\" value=\"HTML\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">DELETE</button>\n  <form data-id='"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "' class=\"update-color\" class=\"crud_form\">\n    <fieldset>\n      <p class=\"form_title\">Update Color</p>\n      <input type=\"text\" name=\"color[favorite]\" required=\"required\" placeholder=\"Color\" pattern=\"[a-zA-Z]+\">\n      <input type=\"submit\">\n    </fieldset>\n  </form>\n  <br>\n  <br>\n</div>\n";
